...
local root_files = { ".git", "build.gradle", "gradlew" }
local features = {
	codelens = false,
	debugger = false,
}

-- Will be used to get the various paths for jdtls
local function get_jdtls_paths()
	...
	-- Can add other java versions here
	path.runtimes = {
		-- Example
		-- {
		-- name = "JavaSE-18"
...
-- Executes every time jdtls attaches to a file
-- Keybindings will be created here
